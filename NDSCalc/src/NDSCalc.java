...
class NDSCalc extends JFrame implements  ActionListener
	 {
	Container c ;
		...
		public NDSCalc()
			{
			super ("N.D.S. Calculator");
		
			c=getContentPane();
			result = new JTextField();
			result.setEditable(false);
			result.setBackground(Color.white);
                        result.setFont(new java.awt.Font("Tahoma", 1, 24));
			...
			for (int i=0;i<16;i++)
			{
                                setFont(new java.awt.Font("Tahoma", 1, 44));
                                b[i] = new JButton(s[i]);
