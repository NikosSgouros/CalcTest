 ...
 * NDSCalculator.java
 *
 * @author Nikos Sgouros
 */
public class NDSCalculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        posneg.setText("+/-");
        posneg.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jLabel1.setFont(new java.awt.Font("Tahoma", 3, 9)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel1.setText("Νίκος Σγούρος");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NDSCalculator().setVisible(true);
            }
        });
    }
